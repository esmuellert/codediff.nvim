...
local test_root = require("tests.support").project_root
...
describe("Installer Module", function()
  ...
  it("Prioritizes unversioned library over versioned one", function()
    ...
    local plugin_root = lib_path_initial and lib_path_initial:match("(.*/)") or test_root .. "/"
